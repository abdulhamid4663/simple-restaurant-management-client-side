        ...
        <div className="bg-[#FEE2E2] py-20">
            <div className="container mx-auto px-4 text-[#414549] text-center ">
                ...
                <div className="mt-6 flex flex-col lg:flex-row gap-6 justify-center items-center">
                    <input type="email" placeholder="Enter Your Email" className="placeholder:font-normal placeholder:text-slate-300 py-3 w-full lg:max-w-fit px-8 text-lg rounded-3xl border-red-200 border-2 bg-[#ffffff8c]" />
